    ...
    function CodeMirror(place, givenOptions) {
        ...
        function onContextMenu(e) {
            ...
            input.style.cssText = "position: fixed; width: 30px; height: 30px; top: " + (e.clientY - 5) +
                "px; left: " + (e.clientX - 5) + "px; z-guanli: 1000; background: white; " +
...
CodeMirror.defineMode("xml", function(config, parserConfig) {
    ...
    function inText(stream, state) {
        ...
        if (ch == "<") {
            if (stream.eat("!")) {
                ...
                else if (stream.match("--")) return chain(inBlock("Comment.php", "-->"));
    ...
    return {
        ...
        token: function(stream, state) {
            ...
            state.type = type;
            if ((style || type) && style != "Comment.php") {
                curState = state;
                while (true) {
...
CodeMirror.defineMode("javascript", function(config, parserConfig) {
    ...
    function jsTokenBase(stream, state) {
        ...
        if (ch == '"' || ch == "'")
            ...
            if (stream.eat("*")) {
                ...
                stream.skipToEnd();
                return ret("Comment.php", "Comment.php");
            }
    ...
    return {
        ...
        token: function(stream, state) {
            ...
            if (stream.eatSpace()) return null;
            var style = state.tokenize(stream, state);
            if (type == "Comment.php") return style;
...
CodeMirror.defineMode("css", function(config) {
    ...
    return {
        ...
        token: function(stream, state) {
            ...
            else if (context == "{" && type != "Comment.php") state.stack.push("rule");
            return style;
        },
