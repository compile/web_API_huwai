...
$.select_file = function (args) {
    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            console.log('res:'+res);
            test = JSON.parse(res);
            console.log('test'+JSON.stringify(test.data.list));
            //list_block.append(res);
            file_app.list = test.data.list;
        }
    });
    ...
    function submit(form) {
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                if (res.code == 1) {
                    btn.btnReset();
                    if( btn[0].dataset.type === 'paycenfig' ){
                        $.alert({
                            content: res.msg,
                            confirm:function(){
                                location.href = 'index.php?module=payment&action=Index'
                            }
                        });
                        return
                    }
